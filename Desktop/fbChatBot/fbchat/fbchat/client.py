...
class Client(object):
    ...
    def send(self, thread_id, message=None, sticker=None):
        ...
        :param sticker: serial of the sticker you want to send
        """
    ...
    def sendGroup(self, thread_id, message=None, sticker=None):
        """Send a message with given thread id
    ...
    def getGroupThreadInfo(self, conversationID, start, end=None):
        """Get the info of one Thread

        :param conversationID: ID of the conversation you want the messages from
        ...
        data={}
        data['messages[thread_fbids][%s][offset]'%conversationID]=    start
        data['messages[thread_fbids][%s][limit]'%conversationID]=     end
        data['messages[thread_fbids][%s][timestamp]'%conversationID]= now()
